...
//   Period 7 (Transactinides): INFRA (g4-5) | LIBRARY (g6-7, g10) | INFRA (g9)
...
const SERVICE_REGISTRY = [
  ...
  { id: 'diskhealth',        symbol: 'No', name: 'Nobelium',     z: 102, mass: '(259)',   period: 10, group: 16, cat: 'ACTINIDE',   zone: 'INFRA',    service: 'DISK-HEALTH',     url: null,                        electronConfig: '[Rn] 5f¹⁴ 7s²',        oxidation: '+3 | +2 | smart-decay | disk',       shells: [2,8,18,32,32,8,2] },
  { id: 'prometheus',        symbol: 'Lr', name: 'Lawrencium',   z: 103, mass: '(266)',   period: 10, group: 17, cat: 'ACTINIDE',   zone: 'INFRA',    service: 'PROMETHEUS',      url: `${PRIMARY_URL}:9090`,       electronConfig: '[Rn] 5f¹⁴ 7s² 7p¹',    oxidation: '+3 | tsdb | scrape | retain',        shells: [2,8,18,32,32,8,3] },
  { id: 'grafana',           symbol: 'Rf', name: 'Rutherfordium',z: 104, mass: '(267)',   period: 7,  group: 4,  cat: 'TRANSITION', zone: 'INFRA',    service: 'GRAFANA',         url: `${PRIMARY_URL}:3010`,       electronConfig: '[Rn] 5f¹⁴ 6d² 7s²',    oxidation: '+4 | viz | panel | dashboard',       shells: [2,8,18,32,32,10,2] },
  { id: 'recoll',            symbol: 'Db', name: 'Dubnium',      z: 105, mass: '(268)',   period: 7,  group: 5,  cat: 'TRANSITION', zone: 'INFRA',    service: 'MAIL-SEARCH',     url: `${SECONDARY_URL}:8087`,     electronConfig: '[Rn] 5f¹⁴ 6d³ 7s²',    oxidation: '+5 | +4 | fulltext | xapian',        shells: [2,8,18,32,32,11,2] },
  { id: 'audiobookshelf',    symbol: 'Sg', name: 'Seaborgium',   z: 106, mass: '(269)',   period: 7,  group: 6,  cat: 'TRANSITION', zone: 'LIBRARY',  service: 'AUDIOBOOKSHELF',  url: `${PRIMARY_URL}:3000/audiobookshelf/`, electronConfig: '[Rn] 5f¹⁴ 6d⁴ 7s²', oxidation: '+6 | +3 | audiobook | listen',       shells: [2,8,18,32,32,12,2] },
  { id: 'kavita',            symbol: 'Bh', name: 'Bohrium',      z: 107, mass: '(270)',   period: 7,  group: 7,  cat: 'TRANSITION', zone: 'LIBRARY',  service: 'KAVITA',          url: `${PRIMARY_URL}:5001`,       electronConfig: '[Rn] 5f¹⁴ 6d⁵ 7s²', oxidation: '+7 | +4 | manga | ebook',            shells: [2,8,18,32,32,13,2] },
  { id: 'kiwix',             symbol: 'Ds', name: 'Darmstadtium', z: 110, mass: '(281)',   period: 7,  group: 10, cat: 'TRANSITION', zone: 'LIBRARY',  service: 'KIWIX',           url: `${SECONDARY_URL}:8089`,     electronConfig: '[Rn] 5f¹⁴ 6d⁸ 7s²',    oxidation: '+0 | wiki | offline | reference',    shells: [2,8,18,32,32,16,2] },
  { id: 'homeplanner',       symbol: 'Rg', name: 'Roentgenium', z: 111, mass: '(282)',   period: 7,  group: 11, cat: 'TRANSITION', zone: 'TOOLS',    service: 'HOMEPLANNER',     url: `${SECONDARY_URL}:3100`,     electronConfig: '[Rn] 5f¹⁴ 6d⁹ 7s²',    oxidation: '+0 | +3 | floorplan | layout | lot', shells: [2,8,18,32,32,17,2] },
  { id: 'queue-manager',     symbol: 'Hs', name: 'Hassium',      z: 108, mass: '(269)',   period: 7,  group: 8,  cat: 'TRANSITION', zone: 'TOOLS',    service: 'QUEUE-MANAGER',   url: null,                        electronConfig: '[Rn] 5f¹⁴ 6d⁶ 7s²',    oxidation: 'stage | batch | queue | schedule-decay',  shells: [2,8,18,32,32,14,2] },
  { id: 'unpackerr',         symbol: 'Mt', name: 'Meitnerium',   z: 109, mass: '(278)',   period: 7,  group: 9,  cat: 'TRANSITION', zone: 'INFRA',    service: 'UNPACKERR',       url: `${PRIMARY_URL}:5656`,       electronConfig: '[Rn] 5f¹⁴ 6d⁷ 7s²', oxidation: '+6 | +4 | extract | unrar',          shells: [2,8,18,32,32,15,2] },
