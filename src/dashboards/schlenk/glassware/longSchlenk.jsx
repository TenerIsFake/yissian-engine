...
export const longSchlenkShape = {
  viewBox: '0 0 70 120',
  jointX: 35, jointY: 4,
  liquidTop: 22, liquidBottom: 112,
  sidearm: false,
  render({ gradId, fillColor, outlineColor, clampedPct }) {
    const fillHeight = (clampedPct / 100) * (112 - 22);
    const fillY = 112 - fillHeight;
    const clipId = `cl-${gradId}`;
    const bodyPath = 'M 22 4 L 48 4 L 48 14 L 46 14 L 46 20 L 44 20 L 44 104 C 44 114 26 114 26 104 L 26 20 L 24 20 L 24 14 L 22 14 Z';
