...
export const allihnShape = {
  ...
  render({ gradId, fillColor, outlineColor, clampedPct }) {
    ...
    const bulbCenters = [30, 50, 70, 90, 110];
    ...
    return (
      <g>
        ...
        {/* Inner bulb train — rendered ON TOP of liquid */}
        {bulbCenters.map((cy) => (
          <circle key={cy} cx="35" cy={cy} r="7" fill="none" stroke="#C0D4DB" strokeWidth="1" />
        ))}
        {/* Water in tab (left) */}
